...
# Flow of deploy app: kubectl apply > api server > event > controller and scheduler listen and create deployment, replicate set, pod
# To listen all event
...
Define how the pods and nodes communicate each other and with external resource. See this decision making from [Microsoft Learn](https://learn.microsoft.com/en-us/training/modules/choose-network-plugin-aks/3-analyze-decision-criteria)
